...
from library.funcoes.banco_de_dados import ink
...
class CardLoopLess:
    ...
    def three_in_a_row_counter(self, reference) -> dict:
        ...
        * portanto, estar var deve ser um inteiro entre [4, 5, 3, 6], senão: jogo inválido \n
    ...
    def build_game_data_report(self) -> None:
        ...
        |5| Números primos diferentes? [{different_prime_numbers_assertion}]
        {self.label}
